...
function MessageSearchPannel(props) {
  ...
  return React__default.createElement("div", {
    ...
    fillColor: index$1.IconColors.ON_BACKGROUND_1,
    width: "22px",
    height: "22px"
  }))), React__default.createElement("div", {
  ...
  }), inputString && loading && React__default.createElement(index$1.Loader, {
    ...
    width: "20px",
    height: "20px"
  })), !loading && inputString && React__default.createElement(index$1.Icon, {
    className: COMPONENT_CLASS_NAME + "__input__container__reset-input-button",
    type: index$1.IconTypes.REMOVE,
    fillColor: index$1.IconColors.ON_BACKGROUND_3,
    width: "20px",
    height: "20px",
