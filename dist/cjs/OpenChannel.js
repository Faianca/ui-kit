...
var index$1$1 = require('./index-a41a85a1.js');
require('react-dom');
var format = _interopDefault(require('date-fns/format'));
var index$2$1 = require('./index-898b3981.js');
...
var FrozenNotification = function FrozenNotification() {
  ...
  }, React__default.createElement(index$1$1.Label, {
    className: "sendbird-frozen-channel-notification__text",
    type: index$1$1.LabelTypography.CAPTION_2
...
function OpenchannelConversationHeader(_a) {
  ...
  return React__default.createElement("div", {
  ...
  }, coverImage ? React__default.createElement(index$1$1.Avatar, {
  ...
  }, React__default.createElement(index$1$1.Icon, {
    type: index$1$1.IconTypes.CHANNELS,
    fillColor: index$1$1.IconColors.CONTENT,
    width: "18px",
    height: "18px"
  })), React__default.createElement(index$1$1.Label, {
    className: "sendbird-openchannel-conversation-header__left__title",
    type: index$1$1.LabelTypography.H_2,
    color: index$1$1.LabelColors.ONBACKGROUND_1
  }, title || stringSet.NO_TITLE), React__default.createElement(index$1$1.Label, {
    className: "sendbird-openchannel-conversation-header__left__sub-title",
    type: index$1$1.LabelTypography.BODY_2,
    color: index$1$1.LabelColors.ONBACKGROUND_2
    ...
    type: amIOperator ? index$1$1.IconTypes.INFO : index$1$1.IconTypes.MEMBERS,
    fillColor: index$1$1.IconColors.PRIMARY,
    width: "24px",
    height: "24px"
  }))));
}
...
function OpenchannelUserMessage(_a) {
  ...
  var MemoizedMessageText = React.useMemo(function () {
    return function () {
      ...
      if (message.updatedAt > 0) {
        matchedMessage.push(React__default.createElement(index$1$1.Label, {
          key: LocalizationContext.uuidv4$1(),
          type: index$1$1.LabelTypography.BODY_1,
          color: index$1$1.LabelColors.ONBACKGROUND_2,
  ...
  return React__default.createElement("div", {
    className: LocalizationContext.__spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-user-message']).join(' '),
    ref: messageRef
  }, React__default.createElement("div", {
    className: "sendbird-openchannel-user-message__left"
  }, !chainTop && React__default.createElement(index$1.ContextMenu, {
    menuTrigger: function menuTrigger(toggleDropdown) {
      return React__default.createElement(index$1$1.Avatar, {
    ...
    type: index$1$1.LabelTypography.CAPTION_2,
    color: isByMe ? index$1$1.LabelColors.SECONDARY_3 : index$1$1.LabelColors.ONBACKGROUND_2
  }, sender && (sender.friendName || sender.nickname || sender.userId)), React__default.createElement(index$1$1.Label, {
    className: "sendbird-openchannel-user-message__right__top__sent-at",
    type: index$1$1.LabelTypography.CAPTION_3,
    color: index$1$1.LabelColors.ONBACKGROUND_3
  ...
  }, isPending && React__default.createElement(index$1$1.Loader, {
    width: "16px",
    height: "16px"
  }, React__default.createElement(index$1$1.Icon, {
    className: "sendbird-openchannel-user-message__right__tail__pending",
    type: index$1$1.IconTypes.SPINNER,
    fillColor: index$1$1.IconColors.PRIMARY,
    width: "16px",
    height: "16px"
  })), isFailed && React__default.createElement(index$1$1.Icon, {
    className: "sendbird-openchannel-user-message__right__tail__failed",
    type: index$1$1.IconTypes.ERROR,
    width: "16px",
    height: "16px"
  }))), React__default.createElement("div", {
    ...
    menuTrigger: function menuTrigger(toggleDropdown) {
      return showMenuTrigger({
        ...
        type: index$1$1.IconTypes.MORE,
        fillColor: index$1$1.IconColors.CONTENT_INVERSE,
        width: "24px",
        height: "24px"
      }));
    },
...
function OpenChannelAdminMessage(_a) {
  var className = _a.className,
      message = _a.message;
  return React__default.createElement("div", {
    className: LocalizationContext.__spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-admin-message']).join(' ')
  }, React__default.createElement(index$1$1.Label, {
...
function OpenchannelOGMessage(_a) {
    ...
    return function () {
      ...
      var matchedMessage = splitMessage.map(function (word) {
        return isUrl(word) ? React__default.createElement(index$2$1.LinkLabel, {
          ...
          src: word,
          type: index$1$1.LabelTypography.BODY_1,
          color: index$1$1.LabelColors.PRIMARY
        }, word) : React__default.createElement(index$1$1.Label, {
          key: LocalizationContext.uuidv4$1(),
  ...
  return React__default.createElement("div", {
    className: LocalizationContext.__spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-og-message']).join(' '),
  ...
  }, ogMetaData.url && React__default.createElement(index$1$1.Label, {
    ...
    src: ogMetaData.url,
    type: index$1$1.LabelTypography.SUBTITLE_2,
    color: index$1$1.LabelColors.PRIMARY
  }, ogMetaData.title), ogMetaData.description && React__default.createElement(index$1$1.Label, {
    ...
    onKeyDown: openLink,
    tabIndex: 0
  }, defaultImage && React__default.createElement(index$1$1.ImageRenderer, {
    ...
    defaultComponent: React__default.createElement("div", {
      ...
      type: index$1$1.IconTypes.THUMBNAIL_NONE,
      width: "56px",
      height: "56px"
    }))
...
function OpenchannelThumbnailMessage(_a) {
  ...
  var sender = getSenderFromMessage(message);
  return React__default.createElement("div", {
    className: LocalizationContext.__spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-thumbnail-message']).join(' ')
  }, React__default.createElement("div", {
  ...
  }, thumbnailUrl ? React__default.createElement(index$1$1.ImageRenderer, {
    className: "sendbird-openchannel-thumbnail-message__right__body__wrap__video",
    url: thumbnailUrl,
    alt: "image",
    height: "270px"
    ...
    type: index$1$1.IconTypes.PLAY,
    width: "56px",
    height: "56px"
  })) : React__default.createElement(index$1$1.Icon, {
    className: "sendbird-openchannel-thumbnail-message__right__body__wrap__video--icon",
    type: index$1$1.IconTypes.PHOTO,
    fillColor: index$1$1.IconColors.ON_BACKGROUND_2,
    width: "56px",
    height: "56px"
  }), _b[SUPPORTING_TYPES.IMAGE] = url || localUrl ? React__default.createElement(index$1$1.ImageRenderer, {
    ...
    width: "56px",
    height: "56px"
  }), _b[SUPPORTING_TYPES.UNSUPPORTED] = React__default.createElement(index$1$1.Icon, {
...
var checkFileType = function checkFileType(fileUrl) {
  ...
  if (imageFile.test(fileUrl)) {
    result = index$1$1.IconTypes.FILE_DOCUMENT;
  } else if (audioFile.test(fileUrl)) {
    result = index$1$1.IconTypes.FILE_AUDIO;
  }
...
function OpenchannelFileMessage(_a) {
  ...
  var sender = getSenderFromMessage(message);
  return React__default.createElement("div", {
    className: LocalizationContext.__spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-file-message']).join(' ')
  }, React__default.createElement("div", {
  ...
  }, checkFileType(message.url) && React__default.createElement(index$1$1.Icon, {
...
function MessageHoc(_a) {
  ...
  return React__default.createElement("div", {
    className: "sendbird-msg-hoc sendbird-msg--scroll-ref"
  }, hasSeperator && React__default.createElement(index$2$1.DateSeparator, null, React__default.createElement(index$1$1.Label, {
    type: index$1$1.LabelTypography.CAPTION_2,
    color: index$1$1.LabelColors.ONBACKGROUND_2
...
function OpenchannelConversationScroll(_a, ref) {
  ...
  return React__default.createElement("div", {
  ...
  }) : React__default.createElement(index$1$1.PlaceHolder, {
    className: "sendbird-openchannel-conversation-scroll__container__place-holder",
    type: index$1$1.PlaceHolderTypes$1.NO_MESSAGES
    ...
    width: "24px",
    height: "24px",
    type: index$1$1.IconTypes.CHEVRON_DOWN,
    fillColor: index$1$1.IconColors.CONTENT
  }))));
}

var OpenchannelConversationScroll$1 = React__default.forwardRef(OpenchannelConversationScroll);
    ...
    case FETCH_PARTICIPANT_LIST:
      {
        ...
        return LocalizationContext.__assign(LocalizationContext.__assign({}, state), {
          participants: LocalizationContext.__spreadArrays(state.participants, fetchedParticipantList)
        });
      }
    ...
    case FETCH_BANNED_USER_LIST:
      {
        ...
        return LocalizationContext.__assign(LocalizationContext.__assign({}, state), {
          bannedParticipantIds: LocalizationContext.__spreadArrays(state.bannedParticipantIds, fetchedBannedUserList.map(function (user) {
            return user.userId;
          }))
        });
      }
    ...
    case FETCH_MUTED_USER_LIST:
      {
        ...
        return LocalizationContext.__assign(LocalizationContext.__assign({}, state), {
          mutedParticipantIds: LocalizationContext.__spreadArrays(state.bannedParticipantIds, fetchedMutedUserList.map(function (user) {
            return user.userId;
          }))
        });
      }
    ...
    case ON_USER_MUTED:
      {
        ...
        return LocalizationContext.__assign(LocalizationContext.__assign({}, state), {
          mutedParticipantIds: LocalizationContext.__spreadArrays(state.mutedParticipantIds, [mutedUser.userId])
        });
      }
    ...
    case ON_USER_BANNED:
      {
        ...
        return LocalizationContext.__assign(LocalizationContext.__assign({}, state), {
          bannedParticipantIds: LocalizationContext.__spreadArrays(state.bannedParticipantIds, [bannedUser.userId])
        });
      }
...
var OpenchannelConversation = function OpenchannelConversation(props) {
  ...
  if (!currentOpenChannel || !currentOpenChannel.url || amIBanned) {
    return React__default.createElement("div", {
      ...
      type: index$1$1.PlaceHolderTypes$1.NO_CHANNELS
    }));
  }
  ...
  if (loading) {
    return React__default.createElement("div", {
      ...
      type: index$1$1.PlaceHolderTypes$1.LOADING
    }));
  }
  ...
  if (isInvalid) {
    return React__default.createElement("div", {
      ...
      type: index$1$1.PlaceHolderTypes$1.WRONG
    }));
  }
  ...
  }), currentOpenChannel.isFrozen && React__default.createElement(FrozenNotification, null), React__default.createElement(OpenchannelConversationScroll$1, {
