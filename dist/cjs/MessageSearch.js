...
function MessageSearchItem(_a) {
  ...
  }, nickname || stringSet.NO_NAME), React__default.createElement(index$1.Label, {
  ...
  }, messageText), React__default.createElement(index$1.Label, {
...
function MessageSearchFileItem(props) {
  ...
  return React__default.createElement("div", {
    ...
    type: index$1.LabelTypography.BODY_2,
    color: index$1.LabelColors.ONBACKGROUND_1
  }, truncate(name || fileMessageUrl, 28)))), React__default.createElement(index$1.Label, {
