...
var Input = React__default.forwardRef(function (props, ref) {
  ...
  }), placeHolder && !inputValue && React__default.createElement(index$1.Label, {
...
function MutedAvatarOverlay(props) {
  ...
  return React__default.createElement("div", {
    ...
    type: index$1.IconTypes.MUTE,
    fillColor: index$1.IconColors.WHITE,
    width: height - 8 + "px",
    height: width - 8 + "px"
  })));
}
...
function UserListItem(_ref) {
  ...
  !user.nickname && React__default.createElement(index$1.Label, {
  ...
  })), user.role === 'operator' && React__default.createElement(index$1.Label, {
...
//# sourceMappingURL=index-7612de95.js.map
