...
var MessageInput = React__default.forwardRef(function (props, ref) {
  ...
  }), !inputValue && React__default.createElement(index$1.Label, {
...
var FileViewerComponent = function FileViewerComponent(_ref) {
  ...
  return React__default.createElement("div", {
  ...
  }, name), React__default.createElement(index$1.Label, {
    ...
    type: index$1.IconTypes.DOWNLOAD,
    height: "24px",
    width: "24px"
  ...
  React__default.createElement("video", {
    ...
    type: index$1.LabelTypography.H_1,
    color: index$1.LabelColors.ONBACKGROUND_1
  }, "Unsupoprted message"))));
};
...
function LinkLabel(_ref) {
  ...
  return React__default.createElement("a", {
    className: [].concat(LocalizationContext._toConsumableArray(Array.isArray(className) ? className : [className]), ['sendbird-link-label', color ? index$1.changeColorToClassName(color) : '']).join(' '),
    href: url,
    target: "_blank",
    rel: "noopener noreferrer"
  }, React__default.createElement(index$1.Label, {
...
LinkLabel.propTypes = {
  ...
  type: PropTypes.oneOf(Object.keys(index$1.LabelTypography)).isRequired,
  color: PropTypes.oneOf(Object.keys(index$1.LabelColors)).isRequired,
...
//# sourceMappingURL=index-898b3981.js.map
