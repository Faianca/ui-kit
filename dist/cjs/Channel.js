...
var utils = require('./utils-9643a8c5.js');
var utils$1 = require('./utils-101e7a33.js');
var index$2 = require('./index-898b3981.js');
var isSameDay = _interopDefault(require('date-fns/isSameDay'));
require('date-fns/formatDistanceToNowStrict');
var index$3 = require('./index-3524921e.js');
...
var getParsedStatus = function getParsedStatus(message, currentGroupChannel) {
  if (message.requestState === FAILED) {
    return utils$1.MessageStatusType.FAILED;
  }

  if (message.requestState === PENDING) {
    return utils$1.MessageStatusType.PENDING;
  }

  if (message.requestState === SUCCEEDED) {
    if (!currentGroupChannel) {
      return utils$1.MessageStatusType.SENT;
    }

    var unreadCount = currentGroupChannel.getReadReceipt(message);

    if (unreadCount === 0) {
      return utils$1.MessageStatusType.READ;
    }

    var isDelivered = currentGroupChannel.getDeliveryReceipt(message) === 0;

    if (isDelivered) {
      return utils$1.MessageStatusType.DELIVERED;
    }
  ...
  return React.useMemo(function () {
    return function (_ref3) {
      ...
      return React__default.createElement(index.EmojiListItems, {
        ...
        }, React__default.createElement(index$1.ImageRenderer, {
          url: emoji.url,
          width: "28px",
          height: "28px",
          defaultComponent: React__default.createElement(index$1.Icon, {
            width: "28px",
            height: "28px",
...
function MessageStatus(_ref) {
  ...
  var label = function label() {
    switch (status) {
      case utils$1.MessageStatusType.FAILED:
      case utils$1.MessageStatusType.PENDING:
        {
          return null;
        }

      case utils$1.MessageStatusType.SENT:
      case utils$1.MessageStatusType.DELIVERED:
      case utils$1.MessageStatusType.READ:
        {
          return React__default.createElement(index$1.Label, {
  ...
  var icon = {
    PENDING: React__default.createElement(index$1.Loader, {
    ...
    SENT: React__default.createElement(index$1.Icon, {
      className: "sendbird-message-status__icon",
      type: index$1.IconTypes.DONE,
      fillColor: index$1.IconColors.SENT,
      width: "16px",
      height: "16px"
    }),
    DELIVERED: React__default.createElement(index$1.Icon, {
      className: "sendbird-message-status__icon",
      type: index$1.IconTypes.DONE_ALL,
      fillColor: index$1.IconColors.SENT,
      width: "16px",
      height: "16px"
    }),
    READ: React__default.createElement(index$1.Icon, {
      className: "sendbird-message-status__icon",
      type: index$1.IconTypes.DONE_ALL,
      fillColor: index$1.IconColors.READ,
      width: "16px",
      height: "16px"
    }),
    FAILED: React__default.createElement(index$1.Icon, {
      className: "sendbird-message-status__icon",
      type: index$1.IconTypes.ERROR,
      fillColor: index$1.IconColors.ERROR,
      width: "16px",
      height: "16px"
    })
  };
...
var ReactionBadge = React__default.forwardRef(function (props, ref) {
  ...
  }, children), React__default.createElement(index$1.Label, {
...
function useMemoizedMessageText(_ref) {
  ...
  var WORD_TYPOGRAPHY = index$1.LabelTypography.BODY_1;
  var EDITED_COLOR = incoming ? index$1.LabelColors.ONBACKGROUND_2 : index$1.LabelColors.ONCONTENT_2;
  return React.useMemo(function () {
    return function () {
...
function IncomingUserMessage(_ref2) {
  ...
  }), !chainTop && React__default.createElement(index$1.Label, {
    className: "sendbird-user-message__sender-name",
    type: index$1.LabelTypography.CAPTION_2,
    color: index$1.LabelColors.ONBACKGROUND_2
  }, utils$1.getSenderName(message)), React__default.createElement("div", {
    className: "sendbird-user-message__text-balloon"
  }, React__default.createElement("div", {
    className: "sendbird-user-message__text-balloon__inner"
  }, React__default.createElement("div", {
  ...
  })), !chainBottom && !(mousehover || moreActive || menuDisplaying) && React__default.createElement(index$1.Label, {
...
var getIsSentFromStatus = function getIsSentFromStatus(status) {
  return status === utils$1.MessageStatusType.SENT || status === utils$1.MessageStatusType.DELIVERED || status === utils$1.MessageStatusType.READ;
};
...
function OutgoingThumbnailMessage(_ref2) {
  ...
  return React__default.createElement("div", {
    ...
    tabIndex: 0
  }, index$2.isVideo(type) && React__default.createElement(React__default.Fragment, null, thumbnailUrl ? React__default.createElement(index$1.ImageRenderer, {
  ...
  React__default.createElement("video", {
    ...
    width: "56px",
    height: "56px"
  })), index$2.isImage(type) && React__default.createElement(index$1.ImageRenderer, {
...
function OutgoingFileMessage(_ref2) {
  ...
  return React__default.createElement("div", {
    ...
    type: index$1.LabelTypography.BODY_1,
    color: index$1.LabelColors.ONCONTENT_1
  }, truncate(message.name || message.url, MAX_TRUNCATE_LENGTH)))), showEmojiReactions && React__default.createElement(EmojiReactions, {
...
function IncomingFileMessage(_ref3) {
  ...
  return React__default.createElement("div", {
    ...
    type: index$1.LabelTypography.BODY_1,
    color: index$1.LabelColors.ONBACKGROUND_1
  }, truncate(message.name || message.url, MAX_TRUNCATE_LENGTH)))), useReaction && message.reactions && message.reactions.length > 0 && React__default.createElement(EmojiReactions, {
...
function OutgoingUnknownMessage(_ref2) {
  ...
  return React__default.createElement("div", {
    ...
    type: index$1.LabelTypography.BODY_1,
    color: index$1.LabelColors.ONBACKGROUND_1
  }, stringSet.UNKNOWN__UNKNOWN_MESSAGE_TYPE), React__default.createElement(index$1.Label, {
...
function IncomingUnknownMessage(_ref3) {
  ...
  }, !chainBottom && React__default.createElement(index$1.Label, {
...
function useMemoizedMessageText$1(_ref) {
  ...
  var WORD_TYPOGRAPHY = index$1.LabelTypography.BODY_1;
  var WORD_COLOR = incoming ? index$1.LabelColors.ONBACKGROUND_1 : index$1.LabelColors.ONCONTENT_1;
  var EDITED_COLOR = incoming ? index$1.LabelColors.ONBACKGROUND_2 : index$1.LabelColors.ONCONTENT_2;
  return React.useMemo(function () {
    return function () {
...
function OutgoingOGMessage(props) {
  ...
  return React__default.createElement("div", {
    ...
    color: index$1.LabelColors.ONBACKGROUND_1
  }, ogMetaData.description)), ogMetaData.url && React__default.createElement(index$1.Label, {
...
function IncomingOGMessage(props) {
  ...
  }, !chainBottom && !(mousehover || moreActive) && React__default.createElement(index$1.Label, {
...
function MessageHoc(_ref) {
  ...
  if (RenderedMessage) {
    ...
    }, hasSeperator && React__default.createElement(index$2.DateSeparator, null, React__default.createElement(index$1.Label, {
      type: index$1.LabelTypography.CAPTION_2,
      color: index$1.LabelColors.ONBACKGROUND_2
  ...
  LocalizationContext._createClass(ConversationScroll, [{
    ...
    value: function render() {
      ...
      if (allMessages.length < 1) {
        return React__default.createElement(index$1.PlaceHolder, {
...
function Notification(_ref) {
  ...
  return (// eslint-disable-next-line
    React__default.createElement("div", {
      ...
      color: index$1.LabelColors.ONCONTENT_1,
      type: index$1.LabelTypography.CAPTION_2
    }, "".concat(count, " "), stringSet.CHANNEL__MESSAGE_LIST__NOTIFICATION__NEW_MESSAGE, " ".concat(timeArray.join(' '))), React__default.createElement(index$1.Icon, {
      width: "24px",
      height: "24px",
      type: index$1.IconTypes.CHEVRON_DOWN,
...
function ConnectionStatus() {
  ...
  return React__default.createElement("div", {
    ...
    type: index$1.LabelTypography.BODY_2,
    color: index$1.LabelColors.ONBACKGROUND_2
  }, stringSet.TRYING_TO_CONNECT), React__default.createElement(index$1.Icon, {
...
function ChatHeader(props) {
  ...
  return React__default.createElement("div", {
  ...
  }, React__default.createElement(index$3.ChannelAvatar, {
    theme: theme,
    channel: currentGroupChannel,
    userId: userId,
    height: 32,
    ...
    color: index$1.LabelColors.ONBACKGROUND_1
  }, title || getChannelTitle(currentGroupChannel, userId, stringSet)), React__default.createElement(index$1.Label, {
    className: "sendbird-chat-header__left__subtitle",
    type: index$1.LabelTypography.BODY_1,
    color: index$1.LabelColors.ONBACKGROUND_2
  }, subTitle)), React__default.createElement("div", {
    className: "sendbird-chat-header__right"
  }, (typeof isMuted === 'string' && isMuted === 'true' || typeof isMuted === 'boolean' && isMuted) && React__default.createElement(index$1.Icon, {
