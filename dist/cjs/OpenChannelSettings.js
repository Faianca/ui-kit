...
var index$4 = require('./index-7ef78461.js');
...
function ChannelAvatar(_a) {
  ...
  var memoizedAvatar = React.useMemo(function () {
    return React__default.createElement(index$1$1.Avatar, {
      ...
      src: utils$2.getOpenChannelAvatar(channel),
      width: width + "px",
      height: height + "px",
...
var EditDetails = function EditDetails(props) {
  ...
  return React__default.createElement(index$1.Modal, {
  ...
  }, currentImg ? React__default.createElement(index$1$1.Avatar, {
    height: "80px",
    width: "80px",
    src: currentImg
    ...
    type: index$1$1.LabelTypography.BUTTON_1,
...
function ChannelProfile(props) {
  ...
  return React__default.createElement("div", {
    ...
    type: index$1$1.LabelTypography.BUTTON_1,
    color: disabled ? index$1$1.LabelColors.ONBACKGROUND_2 : index$1$1.LabelColors.PRIMARY
...
function ParticipantsAccordion(_a) {
  ...
  return React__default.createElement(index$4.Accordion, {
    ...
    renderTitle: function renderTitle() {
      return React__default.createElement(React__default.Fragment, null, React__default.createElement(index$1$1.Icon, {
        type: index$1$1.IconTypes.MEMBERS,
        fillColor: index$1$1.IconColors.PRIMARY,
        width: 24,
        height: 24,
        className: "sendbird-openchannel-settings__accordion-icon"
      }), React__default.createElement(index$1$1.Label, {
        type: index$1$1.LabelTypography.SUBTITLE_1,
        color: index$1$1.LabelColors.ONBACKGROUND_1
    ...
    renderContent: function renderContent() {
      ...
      }), participants && participants.length === 0 ? React__default.createElement(index$1$1.Label, {
...
function DeleteChannel(_a) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
    ...
    type: index$1$1.IconTypes.DELETE,
...
function ParticipantsList(_a) {
  ...
  return React__default.createElement("div", {
    ...
    color: index$1$1.LabelColors.ONBACKGROUND_1
  }, stringSet.OPEN_CHANNEL_SETTINGS__PARTICIPANTS_TITLE), React__default.createElement(index$1$1.Icon, {
    type: index$1$1.IconTypes.CLOSE,
...
function InvalidChannel(_a) {
  ...
  return React__default.createElement("div", {
    ...
    type: index$1$1.LabelTypography.H_2,
    color: index$1$1.LabelColors.ONBACKGROUND_1
  }, stringSet.CHANNEL_SETTING__HEADER__TITLE), React__default.createElement(index$1$1.Icon, {
    type: index$1$1.IconTypes.CLOSE,
    className: "sendbird-openchannel-settings__close-icon",
    height: "24px",
    width: "24px",
    ...
    type: index$1$1.PlaceHolderTypes.WRONG
  })));
}
...
function OpenChannelSettings(props) {
  ...
  return React__default.createElement(index$1.UserProfileProvider, {
    ...
    type: index$1$1.IconTypes.COPY,
    height: "22px",
    width: "22px",
    onClick: function onClick() {
      utils$1.copyToClipboard(channel.url);
    }
  }), React__default.createElement(index$1$1.Label, {
  ...
  }, stringSet.OPEN_CHANNEL_SETTINGS__OPERATOR_URL), React__default.createElement(index$1$1.Label, {
