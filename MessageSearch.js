...
import 'prop-types';
import { A as Avatar, L as Label, a as LabelTypography, b as LabelColors, c as IconTypes, I as Icon, d as IconColors, P as PlaceHolder, h as PlaceHolderTypes } from './index-4bd4c3e1.js';
...
function MessageSearchItem(_a) {
  ...
  return React.createElement("div", {
    className: __spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-message-search-item', selected ? 'sendbird-message-search-item--selected' : '']).join(' '),
...
function MessageSearchFileItem(props) {
  ...
  var stringSet = useContext(LocalizationContext).stringSet;
  return React.createElement("div", {
    className: __spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-message-search-file-item', selected ? 'sendbird-message-search-file-item--selected' : '']).join(' '),
    onClick: function onClick(e) {
      e.stopPropagation();
