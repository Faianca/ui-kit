import { c as _toConsumableArray, g as getStringSet, b as _slicedToArray, m as __spreadArrays, u as uuidv4, d as LocalizationContext } from './LocalizationContext-daa4f283.js';
...
function ImageRenderer(_ref) {
  ...
  }, showDefaultComponent ? DefaultComponent : React.createElement("div", {
...
function changeTypeToIconComponent(type) {
  switch (type) {
    ...
    case Type.BAN:
      return React.createElement(SvgIconBan, null);
    ...
    case Type.CHANNELS:
      return React.createElement(SvgIconChannels, null);

    case Type.CHAT:
      return React.createElement(SvgIconChat, null);

    case Type.CHAT_FILLED:
      return React.createElement(SvgIconChatFilled, null);

    case Type.CHEVRON_DOWN:
      return React.createElement(SvgIconChevronDown, null);

    case Type.CHEVRON_RIGHT:
      return React.createElement(SvgIconChevronRight, null);

    case Type.CLOSE:
      return React.createElement(SvgIconClose, null);

    case Type.COLLAPSE:
      return React.createElement(SvgIconCollapse, null);
    ...
    case Type.DONE_ALL:
      return React.createElement(SvgIconDoneAll, null);
    ...
    case Type.EMOJI_MORE:
      return React.createElement(SvgIconEmojiMore, null);

    case Type.ERROR:
      return React.createElement(SvgIconError, null);

    case Type.EXPAND:
      return React.createElement(SvgIconExpand, null);
    ...
    case Type.MODERATIONS:
      return React.createElement(SvgIconModerations, null);
    ...
    case Type.NOTIFICATIONS_OFF_FILLED:
      return React.createElement(SvgIconNotificationsOffFilled, null);
    ...
    case Type.QUESTION:
      return React.createElement(SvgIconQuestion, null);

    case Type.REFRESH:
      return React.createElement(SvgIconRefresh, null);

    case Type.REMOVE:
      return React.createElement(SvgIconRemove, null);

    case Type.SEARCH:
      return React.createElement(SvgIconSearch, null);

    case Type.SEND:
      return React.createElement(SvgIconSend, null);

    case Type.SETTINGS_FILLED:
      return React.createElement(SvgIconSettingsFilled, null);

    case Type.SPINNER:
      return React.createElement(SvgIconSpinner, null);

    case Type.SUPERGROUP:
      return React.createElement(SvgIconSupergroup, null);

    case Type.THUMBNAIL_NONE:
      return React.createElement(SvgIconThumbnailNone, null);
...
function Avatar(_a, ref) {
  ...
  return React.createElement("div", {
    className: __spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-avatar']).join(' '),
    role: "button",
    ref: ref,
    style: {
      height: height,
...
function PlaceHolder(_ref) {
  ...
  return React.createElement("div", {
  ...
  }, stringSet.PLACE_HOLDER__RETRY_TO_CONNECT))), (type === PlaceHolderTypes$1.NO_RESULTS || type === PlaceHolderTypes$1.SEARCH_IN || type === PlaceHolderTypes$1.SEARCHING) && React.createElement("div", {
    className: "sendbird-place-holder__body--align-top"
  }, type === PlaceHolderTypes$1.SEARCH_IN && React.createElement("div", {
    ...
    color: LabelColors.ONBACKGROUND_2
  }, stringSet.SEARCH_IN), React.createElement(Label, {
    className: "sendbird-place-holder__body--align-top__text__channel-name",
    type: LabelTypography.BUTTON_2,
    color: LabelColors.PRIMARY
  }, "'".concat(searchInString)), React.createElement(Label, {
    className: "sendbird-place-holder__body--align-top__text__quote",
    type: LabelTypography.BUTTON_2,
    color: LabelColors.PRIMARY
  }, '\'')), type === PlaceHolderTypes$1.SEARCHING && React.createElement(Label, {
    className: "sendbird-place-hlder__body--align-top__searching",
    type: LabelTypography.BODY_1,
    color: LabelColors.ONBACKGROUND_2
  }, stringSet.SEARCHING), type === PlaceHolderTypes$1.NO_RESULTS && React.createElement(Label, {
...
export { Avatar$1 as A, Icon as I, Label as L, PlaceHolder as P, LabelTypography as a, LabelColors as b, IconTypes as c, IconColors as d, PlaceHolderTypes as e, ImageRenderer as f, Loader as g, PlaceHolderTypes$1 as h, LabelStringSet as i, changeColorToClassName as j };
//# sourceMappingURL=index-4bd4c3e1.js.map
