import { d as LocalizationContext, n as uuidv4, m as __spreadArrays, _ as __assign, w as withSendbirdContext } from './LocalizationContext-daa4f283.js';
import React, { useContext, useRef, useState, useMemo, useEffect, useCallback, useReducer } from 'react';
import 'prop-types';
import { I as IconButton, f as UserProfileContext, C as ContextMenu, b as MenuItems, g as UserProfile, c as MenuItem, a as TextButton, M as Modal, h as SEND_USER_MESSAGE, S as SEND_MESSAGE_START, i as SEND_FILE_MESSAGE, U as UPDATE_USER_MESSAGE, D as DELETE_MESSAGE, e as UserProfileProvider } from './index-b9d6f6bf.js';
import { L as Label, a as LabelTypography, A as Avatar, I as Icon, c as IconTypes, d as IconColors, b as LabelColors, g as Loader, f as ImageRenderer, P as PlaceHolder, h as PlaceHolderTypes } from './index-4bd4c3e1.js';
import 'react-dom';
import format from 'date-fns/format';
import { M as MessageInput, L as LinkLabel, i as isImage, a as isVideo, D as DateSeparator, F as FileViewer, c as compareIds } from './index-53b12704.js';
...
function OpenchannelUserMessage(_a) {
  ...
  return React.createElement("div", {
    className: __spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-user-message']).join(' '),
    ref: messageRef
  }, React.createElement("div", {
...
function OpenChannelAdminMessage(_a) {
  var className = _a.className,
      message = _a.message;
  return React.createElement("div", {
    className: __spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-admin-message']).join(' ')
  }, React.createElement(Label, {
...
function OpenchannelOGMessage(_a) {
  ...
  return React.createElement("div", {
    className: __spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-og-message']).join(' '),
...
function OpenchannelThumbnailMessage(_a) {
  ...
  var sender = getSenderFromMessage(message);
  return React.createElement("div", {
    className: __spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-thumbnail-message']).join(' ')
  }, React.createElement("div", {
...
function OpenchannelFileMessage(_a) {
  ...
  var sender = getSenderFromMessage(message);
  return React.createElement("div", {
    className: __spreadArrays(Array.isArray(className) ? className : [className], ['sendbird-openchannel-file-message']).join(' ')
  }, React.createElement("div", {
...
var OpenchannelConversationScroll$1 = React.forwardRef(OpenchannelConversationScroll);
    ...
    case FETCH_PARTICIPANT_LIST:
      {
        ...
        return __assign(__assign({}, state), {
          participants: __spreadArrays(state.participants, fetchedParticipantList)
        });
      }
    ...
    case FETCH_BANNED_USER_LIST:
      {
        ...
        return __assign(__assign({}, state), {
          bannedParticipantIds: __spreadArrays(state.bannedParticipantIds, fetchedBannedUserList.map(function (user) {
            return user.userId;
          }))
        });
      }
    ...
    case FETCH_MUTED_USER_LIST:
      {
        ...
        return __assign(__assign({}, state), {
          mutedParticipantIds: __spreadArrays(state.bannedParticipantIds, fetchedMutedUserList.map(function (user) {
            return user.userId;
          }))
        });
      }
    ...
    case ON_USER_MUTED:
      {
        ...
        return __assign(__assign({}, state), {
          mutedParticipantIds: __spreadArrays(state.mutedParticipantIds, [mutedUser.userId])
        });
      }
    ...
    case ON_USER_BANNED:
      {
        ...
        return __assign(__assign({}, state), {
          bannedParticipantIds: __spreadArrays(state.bannedParticipantIds, [bannedUser.userId])
        });
      }
...
var OpenchannelConversation = function OpenchannelConversation(props) {
  ...
  }), currentOpenChannel.isFrozen && React.createElement(FrozenNotification, null), React.createElement(OpenchannelConversationScroll$1, {
